...
| `video_gen` | `video_generate` | Text-to-video, image-to-video, video edit, video extend via plugin-registered backends (xAI Grok-Imagine, FAL.ai Veo / Kling / Pixverse). |
